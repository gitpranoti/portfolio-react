...
function Contact() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_9t6mgoa', 'template_noxqeal', formref.current, {
        publicKey: 'V-mk0IMR0cjLbZPZy',
      })
      .then(
        () => {
          console.log('SUCCESS!');
    ...
    <motion.div className="contact" variants={variants} initial="initial" whileInView="animate">
      <motion.div className="textContainer" variants={variants}>
        ...
        <motion.div className="item" variants={variants}>
            <h2>Mail</h2>
            <span>patilpranoti1812@gmail.com</span>
        </motion.div>
        <motion.div className="item">
            <h2>Address</h2>
            <span>Somnath nagar, Wadgaon sheri, Pune 14.</span>
        </motion.div>
        <motion.div className="item">
            <h2>Phone</h2>
            <span>+91 9604181055</span>
        </motion.div>
      </motion.div>
